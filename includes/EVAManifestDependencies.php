...
// This class generates the MD Report one row at a time for an EVA page. So each object is actually just one row.
class EVAManifestDependencies extends ParserFunctionHelper {
   ...
   public function __construct ( \Parser &$parser ) {
      ...
      parent::__construct(
         ...
         'evamanifestdependencies', // parser function name
